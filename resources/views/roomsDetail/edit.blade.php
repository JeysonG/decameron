...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 py-4 sm:pt-0">
  <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
    <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
      <h1 class="text-gray-900 text-gray-900 dark:text-white">Edit Detail: {{$hotel->name}}</h1>
    </div>

    <div class="row">
      <div class="col">
        <label for="" class="text-gray-900 text-gray-900 dark:text-white mt-2">Rooms Number:</label>
        <span class="text-gray-900 text-gray-900 dark:text-white">{{$hotel->rooms_number}}</span>
    ...
    <div class="row">
      <div class="col">
        <label for="" class="text-gray-900 text-gray-900 dark:text-white mt-2">Rooms without config:</label>
        <span class="text-gray-900 text-gray-900 dark:text-white">{{$hotel->rooms_number - $countRoomsConfig}}</span>
      </div>
    </div>
      ...
      <div class="col">
        ...
        <form action="/rooms_details/{{$rooms_detail->id}}" method="POST">
          ...
          <div class="form-group">
            <label class="text-gray-900 text-gray-900 dark:text-white">Type</label>
          ...
          <div class="form-group mt-2">
            <label class="text-gray-900 text-gray-900 dark:text-white">Category</label>
          ...
          <div class="form-group mt-2">
            <label class="text-gray-900 text-gray-900 dark:text-white">Quantity</label>
